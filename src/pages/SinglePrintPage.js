...
function SinglePrintPage({ setHeaderVisible, headerVisible }) {
      ...
      <div className="container mx-auto h-full relative">
        <div
          className={`flex flex-col lg:flex-row h-full items-center justify-start gap-x-24 text-center lg:text-left  ${
            headerVisible
              ? "pt-36 lg:pt-36 transition-top duration-700 ease-out"
              : "pt-12 lg:pt-36 transition-top duration-700 ease-out"
          }`}
        >
          <motion.div
